...
import { currentUser as queryCurrentUser } from './services/ant-design-pro/apis/userApi';
...
export const layout: RunTimeLayoutConfig = ({ initialState, setInitialState }) => {
  return {
    ...
    waterMarkProps: {
      content:
        'UNSWit ' + (initialState?.currentUser?.userName ? initialState.currentUser.userName : ''),
    },
    footerRender: () => <Footer />,
    onPageChange: () => {
